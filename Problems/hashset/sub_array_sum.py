...
#  write a Python function called subarray_sum that finds the indices of a contiguous subarray in nums that add up to the target sum
...
def subarray_sum(nums , target):
    """
        takes in an array of numbers and return the sub array that adds up
        to target

        sum_index[current_sum - target] is where we began
        i : is where we're at
    """
